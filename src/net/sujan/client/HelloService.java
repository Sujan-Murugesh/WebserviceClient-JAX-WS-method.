 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://ws.sujan.net/", wsdlLocation = "http://localhost:9898/hellows?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://ws.sujan.net/", "HelloService");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://ws.sujan.net/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.sujan.net/", "HelloPort"), Hello.class, features);
    }
